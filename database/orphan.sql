...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2023 at 11:54 AM
...
(21, 'Doummara', 'male', 'Doummar123#', 'admin', 'Doummar@gmail.com', '', ''),
(22, 'Youssef', 'male', 'Youssef123#', 'user', 'Youssef12@gmail.com', '', '');
...
ALTER TABLE `records`
  ...
  ADD UNIQUE KEY `recordsid` (`recordsid`);
...
--
ALTER TABLE `donation`
  MODIFY `iddonation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
